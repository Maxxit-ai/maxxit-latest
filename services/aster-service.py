"""
Aster DEX Trading Service (v3 — EIP-712 Agent Wallet Auth)
Perpetual futures on BNB Chain, using the same agent wallet as Ostium.

Install dependencies:
pip install flask flask-cors requests psycopg2-binary cryptography eth-account

Run:
python services/aster-service.py
