        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-2xl mx-auto text-center mt-16">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Connect your wallet to view your Alpha Clubs and memberships
            </p>
            <button
              onClick={login}
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <h1 className="font-display text-4xl font-bold text-foreground mb-8 uppercase">
            Creator Dashboard
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          <div>
            ...
            >
              CLUB CREATOR DASHBOARD
            </h1>
            <p className="text-muted-foreground">
              Monitor your clubs' performance and earnings
            </p>
          </div>
          <Link
            href="/create-agent"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-card border border-border rounded-lg p-6 hover:border-primary/50 transition-colors">
            ...
            <h3 className="text-sm text-muted-foreground mb-1">Total Clubs</h3>
            <p
        ...
        {agents.length === 0 ? (
          <div className="bg-card border border-border rounded-lg p-12 text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
              Create your first Alpha Club to start earning from
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {/* Join button - available for all club statuses */}
                        <button
