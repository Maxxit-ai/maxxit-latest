      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="mb-12">
          ...
          <h1 className="font-display text-4xl md:text-5xl mb-4">
            {activeTab === "deployments" ? "MY CLUBS" : "ALPHA CLUBS"}
          </h1>
          <p className="text-[var(--text-secondary)] max-w-xl">
            {activeTab === "deployments"
              ? "Manage your Alpha Club memberships and trading settings"
              : "Browse Alpha Clubs and join directly from your dashboard"}
          </p>
        </div>
        ...
        {activeTab === "agents" ? (
          ...
          <div className="border border-[var(--border)] bg-[var(--bg-surface)]">
            <div className="flex flex-col items-center justify-center py-16 px-4">
              ...
              <p className="text-[var(--text-muted)] mb-6 text-center">
                Join an Alpha Club to start automated trading
              </p>
              <a
                href="/"
                className="px-8 py-3 bg-[var(--accent)] text-[var(--bg-deep)] font-bold hover:bg-[var(--accent-dim)] transition-colors"
