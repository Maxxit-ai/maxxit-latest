...
| `/alpha/0g-decision` | POST | Sponsored 0G Compute trade decision. Body: `{ deploymentId, tokenSymbol, marketResearchSummary }`. Returns `{ shouldTrade, side, confidence, reasoning, modelUsed }`. |
