              ...
              <div className="space-y-4">
                <div className="border border-[var(--border)] p-6">
                  ...
                  <p className="text-sm text-[var(--text-secondary)] mb-6">
                    Connect your trading wallet to generate a secure trading address.
                  </p>
                ...
                <div className="border border-[var(--border)] p-4 space-y-2 text-xs text-[var(--text-muted)]">
                  ...
                  <p><span className="text-[var(--accent)]">→</span> One trading address per user (reusable)</p>
            ...
            {step === 'generate' && (
              <div className="space-y-4">
                <div className="border border-[var(--border)] p-6">
                  ...
                  <p className="text-sm text-[var(--text-secondary)] mb-6">
                    Generate your reusable trading address for all club memberships.
                  </p>
              ...
              <div className="space-y-4">
                <div className="border border-[var(--border)] p-6">
                  ...
                  <div className="border border-[var(--border)] p-4 mb-4 space-y-2 text-sm text-[var(--text-secondary)]">
                    ...
                    <p><span className="text-[var(--accent)] font-mono">03</span> Go to Settings → API/Agent Wallet</p>
                    <p><span className="text-[var(--accent)] font-mono">04</span> Add/Authorize trading wallet</p>
            ...
            {step === 'complete' && (
              <div className="space-y-4">
                <div className="border border-[var(--accent)] bg-[var(--accent)]/5 p-8 text-center">
                  ...
                  <h3 className="font-display text-2xl mb-2">JOINED!</h3>
                ...
                <div className="border border-[var(--border)] p-4 space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-[var(--text-muted)]">Trading Wallet</span>
