      ...
      >
        ...
        <div className="sticky top-0 bg-[var(--bg-deep)] border-b border-[var(--border)] p-6 z-10">
          <div className="flex justify-between items-start">
            <div>
              <p className="data-label mb-2">ALPHA CLUB DETAILS</p>
        ...
        <div className="p-6 space-y-8">
              ...
              <div className="space-y-4">
                <div className="border border-[var(--accent)] bg-[var(--accent)]/5 p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-[var(--text-primary)]">CLUB JOINED</p>
          ...
          {/* Club Info */}
          <div>
            <h3 className="font-display text-lg mb-4">CLUB INFO</h3>
